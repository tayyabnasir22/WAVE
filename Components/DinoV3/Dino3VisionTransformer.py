...
from Components.DinoV3.LayerScale import LayerScale
from Components.DinoV3.Mlp import Mlp
from Components.DinoV3.SelfAttentionBlock import SelfAttentionBlock
from Components.DinoV3.SwiGLUFFN import SwiGLUFFN
from Components.DinoV3.PatchEmbed import PatchEmbed
from Components.DinoV3.RMSNorm import RMSNorm
from Components.DinoV3.RopePositionEmbedding import RopePositionEmbedding
from Components.DinoV3.utils import named_apply
...
class Dino3VisionTransformer(nn.Module):
    def __init__(
        self,
        *,
        img_size: int = 224,
